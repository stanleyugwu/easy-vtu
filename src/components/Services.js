  ...
  return (
    ...
    >
      <ServiceCard
        ...
        bounciness={10}
        title="Buy Airtime"
        iconSrc={require("../../assets/service_icons/airtime.png")}
        onPress={(_) =>
      ...
      <ServiceCard
        ...
        bounciness={10}
        title="Buy Data"
        iconSrc={require("../../assets/service_icons/data.png")}
        onPress={(_) =>
          navigation.navigate("NetworkProviders", {
      ...
      <ServiceCard
        ...
        iconSrc={require("../../assets/service_icons/electricity.png")}
      ...
      <ServiceCard
        ...
        title="Tv Cable"
        containerStyle={tw`my-3`}
        iconSrc={require("../../assets/service_icons/cable.png")}
        onPress={(_) => navigation.navigate("NetworkProviders")}
      />
      <ServiceCard
        animationDelay={700}
        bounciness={10}
        title="Scratch Card"
        iconSrc={require("../../assets/service_icons/card.png")}
        onPress={(_) => navigation.navigate("NetworkProviders")}
      />
      <ServiceCard
        animationDelay={800}
        bounciness={10}
        iconSrc={require("../../assets/service_icons/more.png")}
      />
    </ScrollView>
  );
};
