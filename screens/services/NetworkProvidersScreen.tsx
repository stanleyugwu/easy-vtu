...
export type NetworkProvidersNames = "Mtn" | "Glo" | "Airtel" | "9Mobile" | "Ntel" | "Smile";
 ...
 */
const NetworkProvidersScreen = ({route, navigation}:RootStackScreenProps<"NetworkProviders">) => {
      ...
      <SafeArea style={tw`h-full`}>
        {(!rcptModalVisible || !isSignedIn) ? (
          <View style={tw`bg-transparent`}>
            <Text type="title" style={tw`my-6 text-center text-on-background mx-5`}>Which network are you topping up?</Text>
